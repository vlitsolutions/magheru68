...
export const sponsors: Sponsor[] = [
  ...
  {
    name: "Carolin Hotel",
    images: [{ filename: "carolin_hotel.JPG", type: "squared" }]
  },
  {
    name: "Euromarket",
    images: [{ filename: "euromarket.JPG", type: "squared" }]
  },
  {
    name: "Gurmanderie",
    images: [{ filename: "gurmanderie.jpg", type: "squared" }]
  },
  {
    name: "Levant Cuisine",
    images: [{ filename: "levante.jpeg", type: "squared" }]
  }
];