  ...
  const categories = [
    {
      ...
      items: [
        ...
        { title: "Tricou + Cășchetă David Popovici", subtitle: "Campion olimpic 2024 la 200m liber - primul român care a câștigat aur la înot masculin", icon: "🏊‍♂️" },
        { title: "Tricou Dinamo", subtitle: "Tricoul căpitanului Cirjan purtat în victoria cu 3-0 împotriva Petrolului", icon: "⚽" },
